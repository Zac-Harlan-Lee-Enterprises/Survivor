 ...
 *
 * Week 1 was imported from the commissioner's spreadsheet. Weeks 2 and 3 were
 * collected over Teams and Outlook and transcribed, so those carry their real
 * submission date. Week 3 is partial: it is what had arrived by Thursday
 * morning, ahead of the 7:10 PM lock.
 *
 ...
 */
const STORY: Story = {
  'maya-israel': { 1: ['JAX', 'P'], 2: ['BAL', 'P', '2026-09-15T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-22T15:00:00.000Z'] },
  'shahid-ali': { 1: ['BAL', 'P'], 2: ['SF', 'P', '2026-09-15T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-24T15:00:00.000Z'] },
  'dave-johnson': { 1: ['DET', 'P'], 2: ['BAL', 'P', '2026-09-17T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-24T15:00:00.000Z'] },
  'james-parker': { 1: ['DET', 'P'], 2: ['SF', 'P', '2026-09-17T15:00:00.000Z'], 3: ['SEA', 'P', '2026-09-24T15:00:00.000Z'] },
  ...
  'sheila-acker': { 1: ['SEA', 'P'], 2: ['TB', 'P', '2026-09-17T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-24T15:00:00.000Z'] },
  ...
  'allison-petty': { 1: ['DET', 'P'], 2: ['BUF', 'P', '2026-09-17T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-24T15:00:00.000Z'] },
  ...
  'phyllis-collins': { 1: ['SEA', 'P'], 2: ['BUF', 'P', '2026-09-17T15:00:00.000Z'], 3: ['GB', 'P', '2026-09-24T15:00:00.000Z'] },
  ...
  'zac-harlan': { 1: ['LAC', 'P'], 2: ['SF', 'P', '2026-09-17T15:00:00.000Z'], 3: ['KC', 'P', '2026-09-24T15:00:00.000Z'] },
}
